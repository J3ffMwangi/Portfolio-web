    ...
    <footer className="border-t border-slate-800/80 bg-[#090d14] py-14 px-4 sm:px-6 relative">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
        ...
        <div className="space-y-2 max-w-md">
          <div className="flex items-center justify-center md:justify-start gap-2.5">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-cyan-500 via-purple-500 to-rose-500 p-[1px]">
              <div className="w-full h-full bg-[#090d14] rounded-[6px] flex items-center justify-center">
                <Code2 className="w-4 h-4 text-cyan-400" />
              </div>
            </div>
            <div className="flex items-center font-['JetBrains_Mono',monospace]">
              <span className="font-heading font-extrabold text-slate-100 text-base">Code</span>
          ...
          <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
            Software engineering & digital solutions studio crafting modern web systems.
          </p>
        </div>
      ...
      <div className="max-w-5xl mx-auto mt-10 pt-6 border-t border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-400">
        ...
        <p className="flex items-center gap-1">
          Crafted with modern engineering & design precision
        </p>
      </div>
    </footer>
  );
